...
The unemployment rate when the Pandemic struck was the lowest in the Philippines. Major and small companies began to shut down and fire employees because of the virus that was spreading at that time. To solve this issue, the proponents proposed a title that aims to develop an Employment status of the citizens of the Philippines, that will give information on how affected our Filipino workers are. The submitted data, which is presented in this proposed study, will be used as the foundation for applying potential fixes to the stated issue. This epidemic has had a significant impact on the development of our economy and the role that the unemployed play in it.
The proposed title will contribute to\ Sustainable Development Goal (SDG) 8, which seeks to analyze the impact of the pandemic on jobs and work here in the Philippines. This high unemployment rate will cause poverty, hunger, crimes, diseases, etc. But how can we track the unemployment rate of the whole country of the Philippines? It can be on our proposing where we can track and manage unemploy citizens. 
The development of our proposed project has potential benefits for various stakeholders, including program personnel,  Filipino citizens, and the Government. Private and public sectors can also benefit from the proposed project. This can act as a general framework and foundation for figuring out which solutions should probably be given priority. Identifying the study's intended audience can help by enabling participants to understand the problem and offer advice. The justification for activities can be provided by providing accurate information, solutions, and guarantees. Giving the subjects of this study access to this planned initiative can improve the benefits that will be provided to them. 
In summary, the proposed project of tracking the unemployment rate of the Philippines in the Coronavirus Pandemic will provide help to the government for the decision making process. It contributes to improving and enhancing their projects that will provide jobs and solve the case of unemployment. The outcome that is expected to achieve is to reduce unemployment rate and recover from the loss in the pandemic era.
